...
export function ExternalJobDetailPage(){return <div className={styles.page}>
 <PublicHeader/>
 <main>
  ...
  <div className={styles.contentGrid}>
   <article className={styles.mainCard}>
    ...
    <a className={styles.sourceLink} href="#">View original job description ↗</a>
   </article>
   <aside className={styles.side}>
    <CompanySummary status="external" name="Northstar Labs" initials="NL" href="#"/>
    <ListingMetadataCard source="Himalayas" firstSeen="Sep 15" lastChecked="2 hours ago"/>
  ...
  <p className={styles.footerNote}>External jobs remain readable and shareable even when the application happens elsewhere.</p>
 </main>
 </div>}
