...
export function CandidateContext({state="guest",signals=["TypeScript experience aligns","Remote preference aligns","API systems evidence"],signInHref="/login",className}:CandidateContextProps){
